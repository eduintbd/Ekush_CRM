...
function Header({
  ...
  return (
    <div className="flex items-center gap-3 border-b border-gray-200 bg-ekush-orange px-4 py-3 text-white">
      {/* Avatar — drawn portrait at /public/ahona.png. Plain <img> so
          we don't need a Next image-host allowlist for a same-origin
          local asset. */}
      <div className="h-10 w-10 shrink-0 overflow-hidden rounded-full ring-2 ring-white/40 bg-white">
