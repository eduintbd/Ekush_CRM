...
export function EkushChatbot() {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="fixed right-6 top-1/2 -translate-y-1/2 z-50 w-[323px] h-[333px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-visible border border-gray-200">
