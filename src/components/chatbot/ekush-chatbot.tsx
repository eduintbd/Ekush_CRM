  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={handleOpen}
          className="fixed right-6 bottom-6 z-50 w-16 h-16 rounded-full shadow-lg hover:scale-110 transition-all overflow-hidden border-2 border-white"
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="fixed right-6 bottom-6 z-50 w-[323px] h-[333px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-visible border border-gray-200">
